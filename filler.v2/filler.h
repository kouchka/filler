...
/*   Updated: 2018/02/12 14:03:43 by allallem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_up_left_spe(t_filler *p);
void			ft_up_right_spe(t_filler *p);
void			ft_bottom_left_spe(t_filler *p);
void			ft_bottom_right_spe(t_filler *p);
